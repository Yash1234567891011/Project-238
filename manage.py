#Manage.py file is the most important file of the project. It manages how the project
#will run.
#At the top, we import some of the libraries and modules for the project where you will
#notice app.models.* syntax too. They are used to import the models of the database
#Next, we have some dictionaries that contain the seeded data of the database
#10. We have the following functions -
#a. FlaskGroup() that can be used to create commands for managing this
#application -
#b. We have functions recreate_db() and seeder() that resets the DB where the
#recreate_db() functions deleted and then recreated the db and seeder()
#function re-enters the dummy data into the newly created database
