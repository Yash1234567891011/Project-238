#The models folder contains python files for all the tables, that contains the column
#names and their types, through which, the schema of each and every table in our
#database is defined.
